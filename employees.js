...
//CODE HERE
const empOne = new employee("William", "weekday mornings, weekday afternoons");
/*
...
//CODE HERE
const manager = new Manager('Rebecca', 'weekday mornings, weekday afternoons', ['Walter', 'Ozzy'])
